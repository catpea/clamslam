...
This directory contains the browser module implementation of Clam Slam XML v0.5.
...
- `libraries/clamslam-node-editor/` contains the clamslam-node-editor package boundary. This is where `<connect/>`, `<node/>`, `<port/>`, and `<edge/>` belong conceptually.
