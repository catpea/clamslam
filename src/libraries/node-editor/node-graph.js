...
import { DEFAULT_NODE_WIDTH, DEFAULT_PORT_HEADER, DEFAULT_PORT_STEP, MAX_ZOOM, MIN_ZOOM, SVG_NS } from './constants.js';
import './node-card.js';
...
export class FoxVeNodeGraph extends HTMLElement {
  ...
  setProbeBugMode(enabled) {
    ...
    document.querySelector('.app')?.classList.toggle('inject-probe-bugs', this._probeBugMode);
...
customElements.define('fox-ve-node-graph', FoxVeNodeGraph);


export function defineNodeGraph(tag = 'fox-ve-node-graph') {
